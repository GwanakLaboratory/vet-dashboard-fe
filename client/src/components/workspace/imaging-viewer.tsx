            ...
            <CardContent>
                ...
                <ScrollArea className="w-full whitespace-nowrap pb-4">
                    <div className="flex w-max space-x-4">
                        {thumbnails.map((item) => (
                            <div key={item.id} className="w-[150px] aspect-square rounded-md bg-muted flex items-center justify-center relative overflow-hidden cursor-pointer hover:ring-2 ring-primary transition-all">
