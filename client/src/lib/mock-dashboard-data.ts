...
export const mockTestResults: TestItem[] = [
    ...
    // 5. Cardiac Markers
    { id: "CM001", category: "심장표지자", name: "c.NT-proBNP", result: 922, unit: "pmol/L", min: 0, max: 900, status: "High", history: generateHistory(850, 6), synonyms: [] },

    // 6. Serum Biochemistry (AU480)
    { id: "BA001", category: "혈청 생화학 (AU480)", name: "TP", result: 6.7, unit: "g/dL", min: 4.98, max: 7.58, status: "Normal", history: generateHistory(6.5, 6), synonyms: ["Total Protein"] },
    { id: "BA002", category: "혈청 생화학 (AU480)", name: "ALB", result: 3.77, unit: "g/dL", min: 2.4, max: 4.1, status: "Normal", history: generateHistory(3.5, 6), synonyms: ["Albumin"] },
    { id: "BA003", category: "혈청 생화학 (AU480)", name: "ALT", result: 46.1, unit: "U/L", min: 19, max: 77.9, status: "Normal", history: generateHistory(45, 6), synonyms: [] },
    ...
    { id: "BA005", category: "혈청 생화학 (AU480)", name: "ALP(IFCC)", result: 27, unit: "U/L", min: 14, max: 93.2, status: "Normal", history: generateHistory(30, 6), synonyms: [] },
    { id: "BA006", category: "혈청 생화학 (AU480)", name: "GGT", result: 2.7, unit: "U/L", min: 0, max: 14.1, status: "Normal", history: generateHistory(3, 6), synonyms: [] },
    ...
    { id: "BA009", category: "혈청 생화학 (AU480)", name: "CREA", result: 0.78, unit: "mg/dL", min: 0.24, max: 1.17, status: "Normal", history: generateHistory(0.8, 6), synonyms: ["Creatinine"] },
    { id: "BA010", category: "혈청 생화학 (AU480)", name: "UREA", result: 11.76, unit: "mg/dL", min: 10, max: 31.9, status: "Normal", history: generateHistory(12, 6), synonyms: ["BUN"] },
    ...
    { id: "BA012", category: "혈청 생화학 (AU480)", name: "GLU", result: 122, unit: "mg/dL", min: 72.9, max: 115.5, status: "High", history: generateHistory(110, 6), synonyms: ["Glucose"] },
    ...
    { id: "BC001", category: "혈청 생화학 (Catalyst)", name: "ALT", result: 60, unit: "U/L", min: 10, max: 125, status: "Normal", history: generateHistory(55, 6), synonyms: [] },
    ...
    { id: "BC003", category: "혈청 생화학 (Catalyst)", name: "ALKP", result: 25, unit: "U/L", min: 23, max: 212, status: "Normal", history: generateHistory(30, 6), synonyms: ["ALP"] },
    { id: "BC004", category: "혈청 생화학 (Catalyst)", name: "GGT", result: 3, unit: "U/L", min: 0, max: 11, status: "Normal", history: generateHistory(2, 6), synonyms: [] },
    ...
    { id: "BC007", category: "혈청 생화학 (Catalyst)", name: "SDMA", result: 9, unit: "μg/dL", min: 0, max: 14, status: "Normal", history: generateHistory(10, 6), synonyms: [] },
    { id: "BC008", category: "혈청 생화학 (Catalyst)", name: "BUN", result: 9, unit: "mg/dL", min: 7, max: 27, status: "Normal", history: generateHistory(10, 6), synonyms: [] },
    { id: "BC009", category: "혈청 생화학 (Catalyst)", name: "CREA", result: 0.9, unit: "mg/dL", min: 0.5, max: 1.8, status: "Normal", history: generateHistory(0.9, 6), synonyms: [] },
    ...
    { id: "BC012", category: "혈청 생화학 (Catalyst)", name: "TP", result: 6.3, unit: "g/dL", min: 5.2, max: 8.2, status: "Normal", history: generateHistory(6.5, 6), synonyms: [] },
    { id: "BC013", category: "혈청 생화학 (Catalyst)", name: "ALB", result: 3.6, unit: "g/dL", min: 2.3, max: 4, status: "Normal", history: generateHistory(3.5, 6), synonyms: [] },
    { id: "BC014", category: "혈청 생화학 (Catalyst)", name: "GLOB", result: 2.7, unit: "g/dL", min: 2.5, max: 4.5, status: "Normal", history: generateHistory(3.0, 6), synonyms: [] },
    { id: "BC015", category: "혈청 생화학 (Catalyst)", name: "GLU", result: 116, unit: "mg/dL", min: 74, max: 143, status: "Normal", history: generateHistory(110, 6), synonyms: [] },
